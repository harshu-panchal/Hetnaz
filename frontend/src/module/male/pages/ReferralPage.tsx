        ...
        <main className="p-4 space-y-8 mt-2">
          ...
          <div className="bg-white shadow-card rounded-[2.5rem] p-6 relative overflow-hidden group">
            ...
            <div className="flex items-center justify-between relative z-10">
              ...
              <div className="size-16 rounded-[1.5rem] flex items-center justify-center bg-blue-50 shadow-[inner_0_4px_10px_rgba(0,0,0,0.05)]">
                <MaterialSymbol
                  name="groups"
                  className="text-blue-500 drop-shadow-[0_4px_8px_rgba(59,130,246,0.2)]"
                  size={36}
                  filled
                />
              </div>
            ...
            <p className="text-[10px] font-bold text-muted-light mt-4 uppercase tracking-[0.2em]">
